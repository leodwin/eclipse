...
for line in open("bigipconf.cfg",'r'):
...
vs_name = conf[4]
part = conf[5].rstrip()
print ("Fetching config from config file bigipconf",env,".cfg")
...
def switchRule(vs_name, part, operation):
    ...
    if operation == 'ENABLE':
        ...
        virtual_server.rules = ['/MOS_Dev_Stage/mos-ana-12c']
    else:
...
switchRule(vs_name,part,operation)
